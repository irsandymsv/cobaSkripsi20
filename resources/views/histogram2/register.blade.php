	...
	<div id="card_form">
		<form action="{{ route('histogram2.store.user') }}" method="post" enctype="multipart/form-data">
			...
			<div class="form-field">
				...
				<small>Foto ini akan digunakan sebagai media alternatif login</small>
				<br>
			...
			<div class="form-field">
				<button id="btn_register" type="submit" class="btn">Register</button>
			</div>
		</form>	

		<br><br>
		<a href="{{ route('histogram2.login') }}">Login Di sini</a>
	</div>
	
	<div class="card" id="card_success">
		<h1>Selamat</h1>
		<p> Registrasi Berhasil, klik <a href="{{ route('histogram2.login') }}">Login</a> untuk masuk ke akun anda</p>
	</div>
